...
public class CustomerService {
     ...
     */
    @Transaction
    public boolean createCustomer(final Map<String, Object> fieldMap, final FileParam fileParam) {
        final boolean result = DatabaseHelper.insertEntity(Customer.class, fieldMap);
        if (result) {
